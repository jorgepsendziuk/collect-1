...
import com.genesis.coletor.android.activities.GeoShapeGoogleMapActivity;
import com.genesis.coletor.android.activities.GeoShapeOsmMapActivity;
...
public class GeoShapeWidget extends QuestionWidget implements IBinaryWidget {
    ...
    public GeoShapeWidget(Context context, FormEntryPrompt prompt) {
        ...
        createShapeButton.setId(newUniqueId());
