            ...
            if (formDir.exists() && formDir.isDirectory()) {
                ...
                try {
                    ...
                    while (mCursor.moveToNext()) {
                        ...
                        String sqlFilename =
                                mCursor.getString(
                                        mCursor.getColumnIndex(FormsProviderAPI.FormsColumns.FORM_FILE_PATH));
                        String md5 = mCursor.getString(
                                mCursor.getColumnIndex(FormsProviderAPI.FormsColumns.MD5_HASH));
                        ...
                        if (sqlFile.exists()) {
                            ...
                            if (md5Computed == null || md5 == null || !md5Computed.equals(md5)) {
                                ...
                                String id = mCursor.getString(
                                        mCursor.getColumnIndex(FormsProviderAPI.FormsColumns._ID));
