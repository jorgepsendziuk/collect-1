...
import com.genesis.coletor.android.listeners.AudioPlayListener;
import com.genesis.coletor.android.utilities.TextUtils;
...
import com.genesis.coletor.android.listeners.AudioPlayListener;
import com.genesis.coletor.android.utilities.TextUtils;
import com.genesis.coletor.android.views.MediaLayout;
...
public class SelectOneSearchWidget extends QuestionWidget implements
    ...
    public void createOptions(List<SelectChoice> mSearchedItems, List<Integer> tagList) {
        ...
        params.addRule(BELOW, mSearchStr.getId());
