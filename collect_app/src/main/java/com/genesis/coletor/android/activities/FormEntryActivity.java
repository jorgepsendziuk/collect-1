...
import com.genesis.coletor.android.preferences.AdminKeys;
...
import com.genesis.coletor.android.preferences.PreferencesActivity;
...
import com.genesis.coletor.android.exception.GDriveConnectionException;
import com.genesis.coletor.android.exception.JavaRosaException;
import com.genesis.coletor.android.listeners.AdvanceToNextListener;
import com.genesis.coletor.android.listeners.FormLoaderListener;
import com.genesis.coletor.android.listeners.FormSavedListener;
import com.genesis.coletor.android.listeners.SavePointListener;
import com.genesis.coletor.android.logic.FormController;
import com.genesis.coletor.android.logic.FormController.FailedConstraint;
import com.genesis.coletor.android.preferences.AdminKeys;
import com.genesis.coletor.android.preferences.AdminPreferencesActivity;
import com.genesis.coletor.android.preferences.PreferenceKeys;
import com.genesis.coletor.android.preferences.PreferencesActivity;
...
import com.genesis.coletor.android.tasks.FormLoaderTask;
import com.genesis.coletor.android.tasks.SavePointTask;
import com.genesis.coletor.android.tasks.SaveResult;
import com.genesis.coletor.android.tasks.SaveToDiskTask;
import com.genesis.coletor.android.utilities.ApplicationConstants;
import com.genesis.coletor.android.utilities.FileUtils;
import com.genesis.coletor.android.utilities.MediaUtils;
import com.genesis.coletor.android.utilities.ToastUtils;
import com.genesis.coletor.android.views.ODKView;
import com.genesis.coletor.android.widgets.QuestionWidget;
import com.genesis.coletor.android.widgets.StringWidget;
...
public class FormEntryActivity extends Activity implements AnimationListener,
    ...
    private void sendSavedBroadcast() {
        Intent i = new Intent();
        i.setAction("com.genesis.coletor.android.FormSaved");
