...
import static com.genesis.coletor.android.preferences.AdminKeys.KEY_ADMIN_PW;
import static com.genesis.coletor.android.preferences.AdminKeys.KEY_CHANGE_ADMIN_PASSWORD;
import static com.genesis.coletor.android.preferences.AdminKeys.KEY_FORM_PROCESSING_LOGIC;
...
public class AdminPreferencesFragment extends PreferenceFragment implements Preference.OnPreferenceClickListener, Preference.OnPreferenceChangeListener {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        ListPreference mFormProcessingLogicPreference = (ListPreference) findPreference(AdminKeys.KEY_FORM_PROCESSING_LOGIC);
        ...
        Preference mChangeAdminPwPreference = findPreference(AdminKeys.KEY_CHANGE_ADMIN_PASSWORD);
    ...
    public boolean onPreferenceClick(Preference preference) {
        ...
        if (preference.getKey().equals(AdminKeys.KEY_CHANGE_ADMIN_PASSWORD)) {
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference.getKey().equals(AdminKeys.KEY_FORM_PROCESSING_LOGIC)) {
