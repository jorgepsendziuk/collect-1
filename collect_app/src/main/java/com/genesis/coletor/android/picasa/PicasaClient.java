...
package com.genesis.coletor.android.picasa;
...
public final class PicasaClient extends GDataXmlClient {
    ...
    public PhotoEntry executeInsertPhotoEntry(
            PicasaUrl albumFeedUrl, InputStreamContent content, String fileName)
            throws IOException {
    ...
    public PhotoEntry executeInsertPhotoEntryWithMetadata(
        ...
        request.setContent(
                new MultipartContent().setContentParts(Arrays.asList(atomContent, content)));
