...
import static com.genesis.coletor.android.preferences.PreferenceKeys.KEY_SPLASH_PATH;
...
public class PreferencesActivity extends PreferenceActivity {
    ...
    void setSplashPath(String path) {
        ...
        editor.putString(PreferenceKeys.KEY_SPLASH_PATH, path);
        editor.apply();

        PreferenceScreen splashPathPreference = (PreferenceScreen) fragment.findPreference(PreferenceKeys.KEY_SPLASH_PATH);
        String summary = splashPathPreference.getSharedPreferences().getString(
                PreferenceKeys.KEY_SPLASH_PATH, getString(R.string.default_splash_path));
